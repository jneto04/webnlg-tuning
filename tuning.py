...
args_dict.update({'data_dir': '/content/WebNLG', 'output_dir': '/content/t5_webnlg', 'num_train_epochs': 2, 'vocab_file': 'tokenizer_config.json'})
...
model.model.save_pretrained('/home/joaquimneto04/trained_model/t5_small_webnlg')
model.model.eval()